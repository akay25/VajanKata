...
const TermsAndConditionsScreen = () => {
  return (
    <LegalBaseLayout
      heading="Hello 👋"
      subHeading="Before you create an account, please read and accept our privacy and
    policy">
...
We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.`}
      ...
      <Text style={styles.tcH}>Interpretation and Definitions</Text>
      <Text style={styles.tcH}>Interpretation</Text>
      <Text style={styles.tcP}>
        {`The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.`}
      </Text>
      <Text style={styles.tcH}>Definitions</Text>
      <Text style={styles.tcP}>
      ...
      <Text style={styles.tcL}>
        {'\u2022'} Application refers to Chettu, the software program provided
        by the Company.
      </Text>
      <Text style={styles.tcL}>
        {'\u2022'} Company (referred to as either "the Company", "We", "Us" or
        "Our" in this Agreement) refers to Chettu.
      </Text>
      <Text style={styles.tcL}>
      ...
      <Text style={styles.tcH}>Collecting and Using Your Personal Data</Text>
      <Text style={styles.tcH}>Types of Data Collected</Text>
      <Text style={styles.tcH}>Personal Data</Text>
      <Text style={styles.tcP}>
        {`While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:`}
      </Text>
      <Text style={styles.tcL}>{'\u2022'} Email address</Text>
      <Text style={styles.tcL}>{'\u2022'} First name and last name</Text>
      <Text style={styles.tcL}>
        {'\u2022'} Address, State, Province, ZIP/Postal code, City
      </Text>
      <Text style={styles.tcL}>{'\u2022'} Usage Data</Text>
      <Text style={styles.tcH}>Usage Data</Text>
      <Text
        style={
          styles.tcP
...
We may also collect information that Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device.`}</Text>
      <Text style={styles.tcH}>
        Information Collected while Using the Application
      </Text>
      <Text
        style={
          styles.tcP
        }>{`While using Our Application, in order to provide features of Our Application, We may collect, with Your prior permission:`}</Text>
      <Text style={styles.tcL}>
...
You can enable or disable access to this information at any time, through Your Device settings.`}</Text>
      <Text style={styles.tcH}>Use of Your Personal Data</Text>
      <Text
        style={
          styles.tcP
        }>{`The Company may use Personal Data for the following purposes:`}</Text>
      <Text style={styles.tcL}>
      ...
      <Text style={styles.tcH}>Retention of Your Personal Data</Text>
      <Text style={styles.tcP}>
      ...
      <Text style={styles.tcH}>Transfer of Your Personal Data</Text>
      <Text style={styles.tcP}>
      ...
      <Text style={styles.tcH}>Delete Your Personal Data</Text>
      <Text style={styles.tcP}>
      ...
      <Text style={styles.tcH}>Disclosure of Your Personal Data</Text>
      <Text style={styles.tcH}>Business Transactions</Text>
      <Text
        style={
          styles.tcP
        }>{`If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.`}</Text>
      <Text style={styles.tcH}>Law enforcement</Text>
      <Text
        style={
          styles.tcP
        }>{`Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).`}</Text>
      <Text style={styles.tcH}>Other legal requirements</Text>
      <Text
        style={
          styles.tcP
        }>{`The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:`}</Text>
      <Text style={styles.tcL}>{'\u2022'} Comply with a legal obligation</Text>
      <Text style={styles.tcL}>
      ...
      <Text style={styles.tcL}>{'\u2022'} Protect against legal liability</Text>

      <Text style={styles.tcH}>Security of Your Personal Data</Text>
      <Text
        style={
          styles.tcP
        }>{`The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.`}</Text>
      <Text style={styles.tcH}>Children's Privacy</Text>
      <Text
        style={
          styles.tcP
...
If We need to rely on consent as a legal basis for processing Your information and Your country requires consent from a parent, We may require Your parent's consent before We collect and use that information.`}</Text>
      <Text style={styles.tcH}>Links to Other Websites</Text>
      <Text
        style={
          styles.tcP
...
We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.`}</Text>
      <Text style={styles.tcH}>Changes to this Privacy Policy</Text>
      <Text
        style={
          styles.tcP
...
You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.`}</Text>
      <Text style={styles.tcH}>Contact Us</Text>
      <Text style={styles.tcP}>{`
If you have any questions about this Privacy Policy, You can contact us:`}</Text>
      <Text style={styles.tcL}>{'\u2022'} By email: hello@chettu.bio</Text>
    </LegalBaseLayout>
  );
};
